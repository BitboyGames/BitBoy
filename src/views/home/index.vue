    ...
    <div class="sp-track-2">
      <div class="sp-screen-2">
        ...
        <div class="sp2-video-box" @click="pauseBitboy()">
          <video id="newHomeBitboyVideo" ref="sp2-video" muted width="100%" height="100%" preload="auto" playsinline="true" x5-playsinline="true" webkit-playsinline="true" name="media" loop  src="/media/bitboy.mp4"></video>
        </div>
